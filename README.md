...
| File | Description |
|------|-------------|
| `lab_2_predictive_analytics.ipynb` | Main lab notebook (complete workflow + reasoning) |
| `yellow_tripdata.csv` | NYC Yellow Taxi regression dataset |
| `Obesity_level_prediction_dataset (2).csv` | Obesity classification & clustering dataset |
| `requirements.txt` | Python dependencies |
| `lab_2.md` | Lab instructions and grading rubric |

The notebook loads local CSV files when present and falls back to the course URLs for Colab.
